...
const StackItems = () => {
  ...
  return (
    <div className="stack_stack__iZkUS stack foundation_cards__jLR6D One">
      <StackCard 
        svg={
          <img className="w-[50px]" alt="SWC Logo" loading="lazy" width="92" height="32" decoding="async" data-nimg="1" style={{color: "transparent"}} src="/imagens/vision.png" />
        }
        title="Visão"
      ...
      <StackCard 
        svg={
          <img className="w-[50px]" alt="SWC Logo" loading="lazy" width="92" height="32" decoding="async" data-nimg="1" style={{color: "transparent"}} src="/imagens/values.png" />
        }
        title="Valores"
      ...
      <StackCard 
        svg={
          <img className="w-[50px]" alt="SWC Logo" loading="lazy" width="92" height="32" decoding="async" data-nimg="1" style={{color: "transparent"}} src="/imagens/mision.png" />
        }
        title="Misão"
